...
export default function BreakStartModal() {
    ...
    // If showBreakModal is false, the component renders nothing.
    if (!showBreakModal) {
        return null;
    }

    // When showBreakModal is true, it renders the modal.
    return (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            ...
            <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md text-center">
                ...
                <div className="flex flex-col space-y-4">
                    <button
                        onClick={startBreak}
                        className="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-lg text-xl transition-transform transform hover:scale-105"
                    >
                        Start Break
                    </button>
                    <button
                        onClick={pickNewSuggestedActivity}
                        className="bg-gray-600 hover:bg-gray-500 text-gray-200 font-bold py-2 px-4 rounded-lg transition-colors"
                    >
                        Suggest another
                    </button>
                </div>
