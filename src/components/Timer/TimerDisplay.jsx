...
import { PHASES } from '../../constants'; // 1. Import PHASES

export default function TimerDisplay() {
    // 2. Get phase and suggestedActivity from the context
    ...
    return (
        <div className="bg-gray-800 p-8 rounded-xl shadow-2xl w-full text-center relative">
            ...
            {/* This block conditionally renders the activity reminder only during breaks */}
